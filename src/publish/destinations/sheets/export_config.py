...
def export_config(league: str) -> Path:
    ...
    js_content = (
        f'// Auto-generated by publish.destinations.sheets.export_config — do not edit.\n'
        f'// Re-generate: python -m publish.destinations.sheets.export_config --league {league}\n'
