...
from src.output.core.formatting import get_reverse_stats, get_editable_fields
from src.output.destinations.sheets.payloads import _get_subsection_boundaries, _get_section_boundaries
...
def export_config(league: str) -> Path:
    ...
    js_content = (
        f'// Auto-generated by output.core.export — do not edit.\n'
        f'// Re-generate: python -m output.config_export --league {league}\n'
