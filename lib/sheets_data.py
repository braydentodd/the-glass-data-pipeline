...
def get_db_table_columns(conn, db_schema: str, table_name: str, exclude_columns: list = None) -> list:
    """
    ...
    Args:
        ...
        exclude_columns: List of columns to exclude from the return array (e.g. ['player_id', 'updated_at']).
