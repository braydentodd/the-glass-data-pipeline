...
from sheets.core.sheets_sync import (
    get_sheets_client,
...
def get_league_profile(league: str) -> dict:
    ...
    from sheets.core.config import GOOGLE_SHEETS_CONFIG, SHEET_FORMATTING, LEAGUE_CONSTANTS
    from sheets.core.columns import resolve_columns_for_league
