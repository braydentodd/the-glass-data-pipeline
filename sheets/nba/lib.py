...
from etl.nba_api.config import DB_CONFIG, DB_SCHEMA, NBA_CONFIG
...
# Minutes fields for NBA: basic + tracking + hustle tracking + onoff
_MINUTES_FIELDS = {
    'basic':    'minutes_x10',
...
def get_config_for_export(mode: str = 'per_100') -> dict:
    ...
    from etl.nba_api.lib import get_teams_from_db
